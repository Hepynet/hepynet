...
def get_bkg(npy_path, campaign, channel, bkg_list, selected_features):
    ...
    # Load individual bkg
    bkg_dict = get_npy_individuals(npy_path, campaign, channel, bkg_list,
                                   selected_features, "bkg")
...
def get_data(npy_path, campaign, channel, data_list, selected_features):
    ...
    data_dict = get_npy_individuals(npy_path, campaign, channel, data_list,
...
def get_sig(npy_path, campaign, channel, sig_list, selected_features):
    ...
    # Load individual sig
    sig_dict = get_npy_individuals(npy_path, campaign, channel, sig_list,
                                   selected_features, "sig")
